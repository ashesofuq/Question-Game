...
int main(){
    ...
    system("cls");
    printf("\n\t\t--Please Select mode--\n\n");
    printf("\t\t > Press A to Admin\n");
    printf("\t\t > Press U to User\n");
    ...
    printf("\n\t\t  |\\____/|      WELCOME      |\\____/|          ");
    printf("\n\t\t  | -  + |        to         | +  - |       ");
    printf("\n\t\t  |______|   Quiz of Elite   |______|   \n");
    printf("\n\t\t****************************************");
    printf("\n\t\t________________________________________\n");
    printf("\n\t\t BECOME a Millionaire in 10 minutes!!!    ") ;
    //printf("\n");
    printf("\n\t\t________________________________________\n");
    ...
    system("cls");
    printf("\n ------------------  Welcome %s to Quiz Game --------------------------",info.player);
    ...
    switch(r1){
		...
		if (toupper(getch())=='B'){
            ...
            printf("\n\nWrong!!! The correct answer is B.101010");
            getch();
            break;
        }

        case 2:
		printf("\n\n\nWhat is the abbreviation for BTC?");
		printf("\n\nA.Ethereum\t\tB.Cardano\n\nC.Bitcoin\t\tD.Polkadot");
		if (toupper(getch())=='C'){
            printf("\n\nCorrect!!!");count++;
			getch();
			break;
            ...
            printf("\n\nWrong!!! The correct answer is C.Bitcoin");
            getch();
            break;
        }
        case 3:
    ...
    test:
    system("cls");
    printf("\n\n\t*** CONGRATULATION %s you are eligible to play the Game ***",info.player);
